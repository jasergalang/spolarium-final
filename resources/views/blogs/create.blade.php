    ...
    <div class="container py-6 space-x-5 space-y-5 bg-white">
        <div class="grid grid-cols-2">
            ...
            <div class="p-6 bg-white hover:scale-105 hover:shadow-2xl rounded-2xl transition mx-5">
                <div class="text-lg font-bold mb-4 border-b">Blog Title</div>
                <div class="mx-5 my-10">
                    <div class="text-base font-semibold mb-2">Blog Title:</div>
                    <input name="title" placeholder="Enter Title"class="rounded-md border border-gray-300 p-2 w-full">
                </div>
            </div>
        ...
        <!-- Description -->
        <div class="p-6 bg-white hover:scale-105 hover:shadow-2xl rounded-2xl transition mx-5">
            <div class="text-lg font-bold mb-4 border-b">Blog Content</div>
            <div class="mx-5 my-10">
                <div class="text-base font-semibold mr-1 mb-2">Blog Content</div>
                <input type="text" name="content" placeholder="Enter Content" class="rounded-md border border-gray-300 w-full h-20">
            </div>
        </div>
        ...
        <button id="submitartworkdetails" class="uppercase bg-gray-700 hover:bg-red-500 border hover:border-red-500 text-white hover:text-white hover:scale-105 transition font-bold py-2 px-4 w-full h-24 rounded-md my-10 mx-auto block">
            Submit your Blog Details and proceed to adding photos
        </button>
    </div>
</form>
</div>
